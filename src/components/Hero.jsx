    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-20">
      ...
      >
        ...
        <div className="flex gap-6 justify-center">
          <a href="https://github.com/og-arin" target="_blank" className="px-10 py-4 bg-ember text-black rounded-full font-black text-xs uppercase tracking-widest hover:scale-105 shadow-lg shadow-ember/20 transition-all">
            GitHub
          </a>
